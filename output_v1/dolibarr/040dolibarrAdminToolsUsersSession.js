...
scenario.addAction(new lib.ClickAction("#id-left > DIV:nth-child(1) > DIV:nth-child(6) > DIV:nth-child(14) > A:nth-child(1)"));
scenario.addAction(new lib.ClickAction('#id-right > DIV:nth-child(1) > DIV:nth-child(8) > A:nth-child(2)'));
scenario.addAction(new lib.ClickAction('.ui-dialog-buttonset .ui-widget:nth-of-type(1)'));
