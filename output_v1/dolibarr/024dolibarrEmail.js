...
scenario.addAction(new lib.ClickAction('#MAIN_DISABLE_ALL_MAILS'));
scenario.addAction(new lib.ClickAction('#id-right > DIV:nth-child(1) > FORM:nth-child(3) > DIV:nth-child(6) > INPUT:nth-child(1)'));
