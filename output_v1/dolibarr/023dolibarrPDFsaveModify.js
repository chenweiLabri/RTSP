...
scenario.addAction(new lib.ClickAction('#id-right > DIV:nth-child(1) > DIV:nth-child(15) > A:nth-child(1)'));
scenario.addAction(new lib.TypeAction('[name="MAIN_PDF_MARGIN_LEFT"]', '10'));
scenario.addAction(new lib.ClickAction('#id-right > DIV:nth-child(1) > FORM:nth-child(4) > DIV:nth-child(15) > INPUT:nth-child(1)'));
