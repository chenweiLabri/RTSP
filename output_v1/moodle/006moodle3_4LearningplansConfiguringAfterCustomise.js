...
scenario.addAction(new lib.ClickAction("#page-header > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(3) > DIV:nth-child(1) > FORM:nth-child(1) > BUTTON:nth-child(3)"));
scenario.addAction(new lib.ClickAction("#dropdown-8"));
scenario.addAction(new lib.ClickAction("#actionmenuaction-33"));
