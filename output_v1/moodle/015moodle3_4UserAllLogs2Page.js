...
scenario.addAction(new lib.ClickAction("#region-main > DIV:nth-child(1) > DIV:nth-child(2) > DIV:nth-child(2) > DIV:nth-child(2) > SECTION:nth-child(3) > UL:nth-child(2) > LI:nth-child(2) > SPAN:nth-child(1) > A:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#region-main > DIV:nth-child(1) > DIV:nth-child(2) > NAV:nth-child(4) > UL:nth-child(1) > LI:nth-child(2) > A:nth-child(1)"));
