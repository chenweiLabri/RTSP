...
nightmare
  ...
  //click edit
  // .click("[src=\"http\\:\\/\\/localhost\\:8888\\/XoopsCore25-2\\.5\\.9\\/htdocs\\/modules\\/system\\/images\\/icons\\/transition\\/edit\\.png\"]")
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(5) > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(6) > DIV:nth-child(1) > DIV:nth-child(2) > A:nth-child(5) > IMG:nth-child(1)")
  .click("#xo-content > DIV:nth-child(6) > DIV:nth-child(1) > DIV:nth-child(2) > A:nth-child(5) > IMG:nth-child(1)")

  .type("#avatar_name", "avatarName1")

  //click button
  // .click("[value=\"Submit\"]")
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(5) > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(5) > FORM:nth-child(1) > TABLE:nth-child(1) > TBODY:nth-child(1) > TR:nth-child(6) > TD:nth-child(2) > INPUT:nth-child(1)")
  .click("#avt_button")
