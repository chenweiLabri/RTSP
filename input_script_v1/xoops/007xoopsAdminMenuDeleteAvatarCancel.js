...
nightmare
  ...
  //click cancel
  // .click("[name=\"confirm_back\"]")
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(5) > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(5) > FORM:nth-child(4) > INPUT:nth-child(7)")
  .click("#xo-content > DIV:nth-child(5) > FORM:nth-child(4) > INPUT:nth-child(7)")
