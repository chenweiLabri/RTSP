...
nightmare
  ...
  // .click('[name="const\[7\]\[check\]"]')
  // .click('HTML > BODY:nth-child(2) > DIV:nth-child(3) > DIV:nth-child(2) > DIV:nth-child(1) > FORM:nth-child(6) > DIV:nth-child(3) > TABLE:nth-child(1) > TBODY:nth-child(1) > TR:nth-child(10) > TD:nth-child(4) > INPUT:nth-child(2)')
  .click('#check_7')
