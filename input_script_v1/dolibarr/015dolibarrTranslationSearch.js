...
nightmare
  ...
  // .click('#id-right > DIV:nth-child(1) > FORM:nth-child(11) > DIV:nth-child(8) > TABLE:nth-child(5) > TBODY:nth-child(1) > TR:nth-child(2) > TD:nth-child(3) > INPUT:nth-child(1)') //input in td 3 and next td include search
